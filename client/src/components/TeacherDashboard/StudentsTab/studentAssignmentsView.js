            ...
            <CardsContainer>
              {this.state.assignments.map(assignment => (
                <Card key={assignment[0]}  style={{ width:"20%", margin:"2.5%", padding:"1.5%", border: "1px solid #A9E8DC"}}>
                    <CardTitle style={{paddingTop:"6px", fontWeight:"bold"}}>{assignment[1]}</CardTitle> {/* Assignment Name*/}
                    ...
                    <CardText>Music Sheet: <a style={{fontWeight:"bold"}} href={assignment[7]}><img src={assignment[7]} alt="pdf image" /></a></CardText>
                    <CardText>Video: <a  style={{fontWeight:"bold"}} href={assignment[8]}><img src={assignment[8]===null ? 'Not Completed': assignment[8]} alt={assignment[8]===null ? 'Not Completed': "video image"} /></a></CardText>
                    <CardText>Feedback: <span style={{fontWeight:"bold"}}>{assignment[9]===null ? "Not Graded" : assignment[9]}</span></CardText>
                    <CardText style={{paddingBottom:"12px"}}>Grade: <span style={{fontWeight:"bold"}}>{assignment[10]===null ? "Not Graded" : assignment[10]}</span></CardText>
                    {/* <CardText>{assignment[6]}</CardText> */} {/*assignment instructions*/}
