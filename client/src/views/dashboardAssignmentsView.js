    ...
    return (
      <div>
          ...
          <div>
            ...
            <p>Sheet Music: <a href={this.state.sheetMusic}><img src={this.state.sheetMusic} alt="pdf image" height="42" width="42"/></a></p>
            <p>Instructions:{this.state.instructions}</p>
          </div>
            <div>
              <NavLink to='/assignments/create'><h1> + </h1></NavLink>
            </div>
      </div>
    );
  }
